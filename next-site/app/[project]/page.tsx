...
import { ExternalLink, Map, BookOpen, HelpCircle } from 'lucide-react'
...
export default function ProjectPage({ params }: { params: { project: string } }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-8 py-10">
      <div className="mb-8">
        <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full border text-xs font-mono mb-4 ${accentColor}`}>
          {project.shortName}
        </div>
      ...
      <div>
        <h2 className="text-lg font-semibold text-white mb-4">所有功能模組</h2>
