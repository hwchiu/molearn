...
export const PROJECTS: Record<ProjectId, ProjectMeta> = {
  'cluster-api': {
    ...
    usecases: ['multi-team-platform', 'cluster-self-healing', 'gitops-cluster-fleet', 'cross-provider-migration'],
    difficulty: '🟡 中階',
  ...
  'cluster-api-provider-maas': {
    ...
    usecases: ['on-demand-baremetal', 'ci-ephemeral-cluster', 'failure-domain-ha'],
    difficulty: '🟡 中階',
    difficultyColor: 'text-yellow-400 bg-yellow-400/10 border-yellow-400/30',
  ...
  'cluster-api-provider-metal3': {
    ...
    usecases: ['edge-auto-recovery', 'bulk-os-upgrade', 'ztp-datacenter-onboarding', 'firmware-lifecycle-management'],
    difficulty: '🔴 進階',
  ...
  'rook': {
    ...
    usecases: ['stateful-storage', 'rbd-mirroring-disaster-recovery', 'nvme-performance-tuning'],
    difficulty: '🟡 中階',
    difficultyColor: 'text-yellow-400 bg-yellow-400/10 border-yellow-400/30',
  ...
  'kube-ovn': {
    ...
    usecases: ['multi-tenant-network', 'bgp-direct-pod-routing', 'vpc-peering-service-mesh'],
    difficulty: '🔴 進階',
    difficultyColor: 'text-red-400 bg-red-400/10 border-red-400/30',
  ...
  'kubevirt': {
    ...
    usecases: ['vm-container-mixed', 'live-migration-maintenance', 'vm-backup-restore-cdi'],
    difficulty: '🔴 進階',
    difficultyColor: 'text-red-400 bg-red-400/10 border-red-400/30',
